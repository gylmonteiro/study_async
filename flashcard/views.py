...
def novo_flashcard(request):
    ...
    if request.method == 'GET':
        ...
        # if categoria_filtrar or dificuldade_filtrar:
        #     flashcards = flashcards.filter(Q(categoria__id=categoria_filtrar)| Q(dificuldade=dificuldade_filtrar))
        ...
        return render(
            request,
            'novo_flashcard.html', {'categorias': categorias, 'dificuldades': dificuldades, 'flashcards': flashcards}
        )
...
def deletar_flashcard(request, id):
    ...
    if request.user == flashcard.user:
        ...
        messages.add_message(request, constants.ERROR, 'Esse flashcard não pertence a você')
        return redirect('/flashcard/novo_flashcard')
...
def desafio(request, id):
    ...
    if request.method == 'GET':
        ...
        return render(
            ...
            'desafio.html',
            {
                'desafio': desafio, 'acertos': acertos, 'erros': erros, 'faltantes': faltantes
            },
        )
